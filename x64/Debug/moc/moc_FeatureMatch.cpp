...
QT_MOC_LITERAL(1, 13, 8), // "sendflag"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 8), // "OpenImg1"
QT_MOC_LITERAL(4, 32, 8), // "OpenImg2"
QT_MOC_LITERAL(5, 41, 10) // "SendQimage"

    },
    "FeatureMatch\0sendflag\0\0OpenImg1\0"
    "OpenImg2\0SendQimage"
};
...
void FeatureMatch::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendflag((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->OpenImg1(); break;
        case 2: _t->OpenImg2(); break;
        case 3: _t->SendQimage(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (FeatureMatch::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FeatureMatch::sendflag)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FeatureMatch::sendflag(bool _t1)
{
